...
var SnowStorm = function (window, document) {
	...
	this.SnowFlake = function (type, x, y) {
		...
		this.twinkleFrame = 0;
		this.active = 1;
		this.fontSize = 10 + (this.type / 5) * 10 * storm.snowflakeSizeMulti;
		...
		if (window.getComputedStyle) {
			...
			try {
				targetElementIsRelative =
					window.getComputedStyle(storm.targetElement, null).getPropertyValue('position') ===
					'relative';
			} catch (e) {
				// oh well
				targetElementIsRelative = false;
